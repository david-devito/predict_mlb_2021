...
statsDF['HomeRun'] = statsDF['HomeRun'].apply(lambda x: 1 if x >= 1 else 0)
...
pickle.dump(fillna_dict, open('fillna_means_hitter_homers.pkl', 'wb'))
...
pickle.dump(kbins, open('kbins_hitter_homers.pkl', 'wb'))
...
pickle.dump(rf, open('finalized_model_hitter_homers.sav', 'wb'))
