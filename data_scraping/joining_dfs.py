...
def combine_df_hitterhomers(year):
    ...
    homers = pd.read_csv('input/gamelogs/gamelogs' + str(year) + '_hitters_homers_dkpts.csv', sep=',')
    curDF = pd.merge(curDF, homers,  how='left', left_on=['Date','AwayTeam','HomeTeam'], right_on = ['Date','AwayTeam','HomeTeam'])
