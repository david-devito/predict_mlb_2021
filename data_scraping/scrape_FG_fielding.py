# Scrapes fangraphs for batting statistics from given year
...
def get_soup(start_season, end_season, league, qual, ind, adjhandVar, statsCols):
    ...
    url =  'http://www.fangraphs.com/leaders.aspx?pos=all&stats=fld&lg={}&qual={}&type=' + statsCols + '&season={}&month={}&season1={}&ind={}&team=&rost=&age=&filter=&players=&page=1_10000'
...
def fielding_stats(start_season, end_season=None, league='all', qual=1, ind=1, handVar='B', statsCols=list(range(1,50))):
